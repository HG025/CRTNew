...
class Searchbycrimelocation extends StatefulWidget {
  final List<Map<String, dynamic>> documents;

  const Searchbycrimelocation({Key? key, required this.documents})
      : super(key: key);

  @override
  State<Searchbycrimelocation> createState() => _SearchbycrimelocationState();
}

class _SearchbycrimelocationState extends State<Searchbycrimelocation> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Search By Crime Area'),
