...
class Searchbycrimetype extends StatefulWidget {
  final List<Map<String, dynamic>> documents;

  const Searchbycrimetype({Key? key, required this.documents})
      : super(key: key);

  @override
  State<Searchbycrimetype> createState() => _SearchbycrimetypeState();
}

class _SearchbycrimetypeState extends State<Searchbycrimetype> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Search By Crime Type'),
